...
function MultiStepForm() {
  const { steps, currentStepIndex, step, isFirstStep, isLastStep, back, next } =
    useMultiStepForm([<UserFormPhone />, <UserFormEmail />]);
  return (
    <div className="flex flex-col items-center">
      <div className="w-[670px] bg-violet-50 rounded-[20px] border-t-2 border-slate-900">
        ...
        <div className="flex justify-between bg-violet-700 rounded-bl-[18px] rounded-br-[18px]">
          {!isFirstStep && (
            <button type="button" onClick={back} className="grow">
              <div className="flex items-center justify-center">
                ...
                <div className="ml-[10px] text-violet-50 text-sm font-bold uppercase leading-tight">
                  Previous
                </div>
              </div>
            </button>
          ...
          <button
            type="button"
            onClick={next}
            className="grow py-[20px] rounded-br-[18px]"
          >
            <div className={`flex items-center ${isFirstStep? 'justify-end mr-[98px]': 'justify-center' }`}>
              <div className="mr-[10px] text-white text-sm font-bold uppercase">
